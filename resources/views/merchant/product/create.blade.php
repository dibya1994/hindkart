                            ...
                            <div class="live-preview">
                                ...
                                <div class="row my-4">
                                    <div class="col-xxl-3 col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="attr_value[]"  placeholder="eg. XL/ XXL / 50g / 100g">
                                    </div>
                                    <div class="col-xxl-3 col-md-3">
                                        <label for="placeholderInput" class="form-label">Market Price</label>
                                        <input type="number" step="any" class="form-control" name="market_price[]"  placeholder="Enter MRP">
                                    </div>
                                    <div class="col-xxl-3 col-md-3">
                                        <label for="placeholderInput" class="form-label">Sale Price</label>
                                        <input type="number" step="any" class="form-control" name="sale_price[]"  placeholder="Enter Sale Price">
                                    </div>
                                    <div class="col-xxl-3 col-md-3">
                                        <label for="placeholderInput" class="form-label">Stock</label>
                                        <input type="number" step="any" class="form-control" name="stock[]"  placeholder="Enter Stock">
                                    </div>
                                </div>
                                </div>
                                <div class="row">
