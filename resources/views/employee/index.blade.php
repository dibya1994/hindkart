...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Hindkart - Employee Panel</title>
...
<body>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign In as a Employee</p>
                                </div>
    ...
    @endif
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" method="POST" action="{{ url('/employee/login') }}">
                                        @csrf
                                        <div class="mb-3">
