                                ...
                                <tbody>
                                    ...
                                    @foreach ($row as $details)
                                        <tr>
                                            ...
                                            {{-- <td><a href="{{url('/employee/employee/edit/'.$details->id)}}"><i data-feather="edit"></i></a></td>
                                            <td><i data-feather="archive" onclick="delete_row({{$details->id}})"></i></td>
                                            <form action="{{url('/employee/employee/delete')}}" method="post" id="delete_submit{{$details->id}}" style="display:none;">
