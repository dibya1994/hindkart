    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                ...
                                <div class="newclass">
                                    <p class="newtitle">Merchant Section</p>
                                    <div class="row gy-4">
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                <label for="placeholderInput" class="form-label">Registration Fee*</label>
                                                <input type="text" class="form-control" name="merchant_reg" placeholder="Registration Fee" value="{{ $monthlyfee->merchant_reg }}" required>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                <label for="placeholderInput" class="form-label">Monthly Fee*</label>
                                                <input type="text" class="form-control" name="merchant_monthly" placeholder="Monthly Fee" value="{{ $monthlyfee->merchant_monthly }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
