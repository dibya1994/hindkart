                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Sub  Category List <a href="{{ url('/admin/subcategory/create') }}"><button class="btn btn-primary">Add+</button></a></h5>
                        ...
                        <div class="card-body">
                            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                    $row=DB::table('subcategories')->get();
                                    @endphp
                                    @foreach ($row as $details)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{url('/admin/subcategory/'.$details->id.'/edit')}}"><i data-feather="edit"></i></a></td>
                                            <td><i data-feather="archive" onclick="delete_row({{$details->id}})"></i></td>
                                            <form action="{{url('/admin/subcategory/'.$details->id)}}" method="post" id="delete_submit{{$details->id}}" style="display:none;">
                                                    {{ method_field('DELETE') }}
                                                        {{csrf_field()}}
                                            </form>
                                        </tr>
