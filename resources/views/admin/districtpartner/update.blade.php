...
@php
    $details=DB::table('districtpartners')->where('id',$id)->first();
@endphp
<div class="main-content">
    ...
    <h4 class="card-title mb-0 flex-grow-1">Update District Partner</h4>
    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{url('/admin/districtpartner/update')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xxl-3 col-md-4">
                                            <div>
                                                ...
                                                <select class="form-control" name="district_id" required>
                                                    ...
                                                    @php
                                                    $district_row=DB::table('district')->where('zone_id',$details->zone_partner_id)->get();
                                                    @endphp
                                                    @foreach ($district_row as $district_details)
                                                        <option value="{{ $district_details->id }}" {{ $details->district_id==$district_details->id?'selected':'' }}>{{ $district_details->district }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
