...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Hindkart - District Franchise Panel</title>
...
<body>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign In as a District Franchiser</p>
                                </div>
    ...
    @endif
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" method="POST" action="{{ url('/district-franchise/login') }}">
                                        @csrf
                                        <div class="mb-3">
